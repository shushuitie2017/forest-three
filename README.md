...
这片森林最早由一位日本开发者用 AI 辅助搓了出来——地形逻辑、贴图图集、角色行走精灵，都是一点点拼起来的实验作品。我把它整个搬进中文语境：界面、说明、构建链全部本地化，换上自己的域名与 Pages，让中文玩家也能一键走进来。

原作的美术与生成逻辑完好保留，我做的是「让它说中文、能一键上线」。开源协议见 [LICENSE](LICENSE)。
...
AI-native builder｜把有意思的开源项目搬进中文世界
